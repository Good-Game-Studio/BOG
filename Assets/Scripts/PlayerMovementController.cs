...
public class PlayerMovementController : MonoBehaviour
{
    ...
    IEnumerator DashCroutine()
    {
        ...
        {
            //rb.AddForce(Vector2.right * player.playerDirection.x * dashForce * 1000f, ForceMode2D.Impulse);
            //transform.Translate(Vector2.right * player.playerDirection.x * moveSpeed * 0.02f * (100 / player.playerAttributes.speed));
